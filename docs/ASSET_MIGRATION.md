...
| `assets/bosses/stage1_foreman/slam_sheet.png` | Approved four-frame ground slam from `agent/art-production` commit `5345238`; 2x2 cells at 512x512 | Integrated as the Undead Foreman `slam` animation with a frame-2 local impact and twin shockwave event |
