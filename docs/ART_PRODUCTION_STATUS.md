...
- zombie doctor identity is the next character-art task
...
3. Produce the zombie doctor identity with explicit user review.
4. After identity approval, produce the doctor walk, electric attack, hurt, and defeated states.
