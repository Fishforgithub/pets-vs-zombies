...
- Chief Surgeon boss identity and four-frame heavy locomotion are delivered; phase-one attacks are next
...
3. Produce the Chief Surgeon four-stage horizontal sweep with explicit user review.
4. Produce the overhead slam and impact sequence after sweep approval.
