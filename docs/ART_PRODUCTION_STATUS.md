...
- zombie doctor identity is delivered; walk and electric-action sheets are next
...
3. Produce the zombie doctor six-frame walk cycle with explicit user review.
4. Produce the doctor electric attack, hurt, and defeated states after walk approval.
