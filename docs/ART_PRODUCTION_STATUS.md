...
- Chief Surgeon boss identity, heavy locomotion, and four-stage horizontal sweep are delivered; overhead slam is next
...
3. Produce the Chief Surgeon four-stage overhead slam with explicit user review.
4. Produce boss reaction, phase transition, stunned, and defeated states after slam approval.
