...
- zombie nurse identity is the next character-art task
...
3. Produce the zombie nurse identity with explicit user review.
4. After identity approval, produce the nurse walk, throw/buff, hurt, and defeated states.
