...
- Chief Surgeon boss identity is delivered; locomotion and combat state production is underway
...
3. Produce the Chief Surgeon four-frame heavy locomotion cycle with explicit user review.
4. Produce phase-one sweep and overhead-slam attacks after locomotion approval.
